...
ProgramBuilder.prototype.load = function(code, port, board) {
    ...
    logger.info('Program size: ', sizeof(this.trimmed_commands), '. Max size available in the board: ', bitbloqSU.Serial.getDeviceInfo().boardInfo.max_size);
