...
Handler.programMock = function() {
    ...
    bitbloqSU.Program
        .setBoard(request.board)
        .load(request.data, request.path, request.board)
        .then(programHandler).catch(programHandler);
};

Handler.add('program', Handler.programMock);
